...
const Serviqore = () => {
    return (
        <div className='text-center md:w-10/12 w-11/12 mx-auto'>
           <div> <h1 className="font-semibold text-[36px] text-black">Partner with Serviqore</h1>
            <p className='font-normal my-3 text-[16px] leading-[16px] text-[#959595]'>Your Trusted Ally in Remote Security Supervision.</p>
            ...
            <div>
                ...
                <button className='flex items-center justify-center gap-2 bg-primary text-white py-2 px-4 my-6 rounded mx-auto'><span>Get a Quote </span> <FaLongArrowAltRight /></button>
            </div>
        </div>
    );
};
