  ...
  return (
    <div className="mt-8">
      ...
      <div className="w-11/12 md:w-10/12 mx-auto my-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7 md:gap-14">
          {services.map((item, index) => (
            <div key={index} className="flex flex-col items-center">
              ...
              <div>
                ...
                <p className="text-justify text-[14px] text-textMuted leading-[20px]">{item.text}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="md:px-28 px-5 py-10 mx-auto my-10 bg-[#F9FDFC]">
          <h1 className="text-center text-black py-8 font-bold text-[30px]">Why Choose Us?</h1>
          ...
          <div className="flex flex-col items-center">
              ...
              <div>
                ...
                <p className="text-justify text-[14px] text-textMuted leading-[20px]">With years of experience in the recruitment industry, our team has the knowledge and expertise to deliver exceptional results for our clients.</p>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <div className="p-3">
              ...
              <div>
                ...
                <p className="text-justify text-[14px] text-textMuted leading-[20px]">We understand that every business is unique, which is why we tailor our services to meet your specific needs and objectives.</p>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <div className="p-3">
              ...
              <div>
                ...
                <p className="text-justify text-[14px] text-textMuted leading-[20px]">Our streamlined processes and advanced technology enable us to identify and secure top talent quickly and efficiently, saving you time and resources.</p>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <div className="p-3">
              ...
              <div>
                ...
                <p className="text-justify text-[14px] text-textMuted leading-[20px]">From initial consultation to post-placement follow-up, our team is committed to providing personalized support and guidance every step of the way.</p>
              </div>
            </div>
          </div>
      </div>

      <div className="md:px-20 px-5 text-center mt-5  mb-14">
        <h1 className="text-black text-[30px] font-bold py-4">Get Started Today</h1>
        <p className="text-textMuted text-[16px]">Ready to take your recruitment efforts to the next level? Contact us today to learn more about our Virtual Resourcing Service and discover how we can help you build a winning team for your organization.</p>
      </div>
    </div>
  );
};
